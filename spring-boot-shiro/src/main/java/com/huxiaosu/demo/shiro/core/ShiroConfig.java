...
import com.huxiaosu.demo.shiro.config.ShiroFileConfig;
...
public class ShiroConfig {
    ...
    @Autowired
    private ShiroFileConfig shiroFileConfig;
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        shiroFilterFactoryBean.setLoginUrl(shiroFileConfig.getLoginUrl());
        // 登录成功后要跳转的链接
        shiroFilterFactoryBean.setSuccessUrl(shiroFileConfig.getSuccessUrl());
        // 未授权界面;
        shiroFilterFactoryBean.setUnauthorizedUrl(shiroFileConfig.getUnauthorizedUrl());
        // 配置数据库中的resource
    ...
    public SimpleCookie rememberMeCookie() {
        ...
        simpleCookie.setMaxAge(redisConfig.getExpire());
        return simpleCookie;
    }
